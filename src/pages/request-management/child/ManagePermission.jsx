    ...
    >
      ...
      <div className="fixed top-0 left-0 z-30 flex justify-between w-full px-3 py-2 text-white h-max gradient-1 md:hidden ">
        <ArrowLeftIcon
          ...
          onClick={handleBack}
        />
        <span>Pengajuan Izin Karyawan</span>
      ...
      >
        {/* title */}
        <h1 className="text-lg font-semibold w-max">Pengajuan Izin Karyawan</h1>
        {/* button filter */}
        <div
          className={`md:w-full w-max md:bg-white/0 rounded-lg bg-white md:p-0 md:px-0 p-2 px-4 flex  text-sm transition-all duration-300 ${
