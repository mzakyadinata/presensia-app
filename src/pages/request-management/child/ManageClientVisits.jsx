...
export default function ManageClientVisits() {
    ...
    >
      ...
      <div className="fixed top-0 left-0 z-30 flex justify-between w-full px-3 py-2 text-white h-max gradient-1 md:hidden ">
        <ArrowLeftIcon
          ...
          onClick={handleBack}
        />
        <span>Pengajuan Kunjungan Klien Karyawan</span>
      ...
      >
        ...
        <h1 className="text-lg font-semibold w-max">
          Pengajuan Kunjungan Klien Karyawan
        </h1>
        {/* button filter */}
        <div
      ...
      <SplashSuccess
        ...
        title={`Pengajuan ${
          approvalData == "setuju" ? "Disetujui" : "Ditolak"
        }`}
      >
        Pengajuan Kunjungan Klien Berhasil{" "}
